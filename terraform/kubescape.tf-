...
resource "kubernetes_namespace" "kubescape-east" {
...
resource "kubernetes_namespace" "kubescape-west" {
...
resource "helm_release" "kubescape-east" {
  depends_on = [kubernetes_namespace.kubescape-east,
  ...
  description = "HELM Chart to install the Kubescape operator."
...
resource "helm_release" "kubescape-west" {
  depends_on = [kubernetes_namespace.kubescape-west,
